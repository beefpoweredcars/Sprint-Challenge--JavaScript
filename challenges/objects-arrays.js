...
const displayNames = [];
zooAnimals.forEach(zooIndex => {
  displayNames.push(`Name: ${zooIndex.animal_name}, Scientific: ${zooIndex.scientific_name}`)});
...
const lowCaseAnimalNames = zooAnimals.map(zooIndex =>{
  zooIndex.animal_name.toLowerCase()
});
...
zooAnimals.push(lowCaseAnimalNames)
}
